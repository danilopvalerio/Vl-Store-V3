...
// Importamos o componente da linha e a interface
import AccessLogRow, { AccessLog } from "./AccessLogRow";
...
const AccessLogsPage = () => {
  ...
  const fetchLogs = async (page = 1, term = "") => {
    ...
    try {
      ...
      // TRATAMENTO DE ERRO ATUALIZADO (Conforme solicitado)
  ...
  return (
    ...
    >
      ...
      <footer className="">© 2025 Sistema VL. Logs de Auditoria.</footer>
    </div>
  );
};
